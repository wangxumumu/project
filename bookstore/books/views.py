...
def list(request,type_id,page):
	...
	#1.总页数<5,显示所有页码
	#2.当前页是前３页，显示１－５页
	#3.当前页是后３页，显示后５页　10 9 8 7
	#4.其他情况，显示当前页前２页，后２页，当前页
	if num_pages < 5:
		pages = range(1,num_pages+1)
	elif page <= 3:
		pages = range(1,6) # [1,2,3,4,5]
	elif num_pages - page <= 2:
		pages = range(num_pages-4,num_pages+1) # [96,97,98,99,100]
	else:
		pages = range(page-2,page+3) # [5,6,7,8,9]
