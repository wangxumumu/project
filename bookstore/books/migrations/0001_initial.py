    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.SmallIntegerField(verbose_name='类型id', choices=[(1, 'Python'), (2, 'Javascript'), (3, '数据结构与算法'), (4, '机器学习'), (5, '操作系统'), (6, '数据库')], default=1)),
                ('name', models.CharField(verbose_name='商品名称', max_length=30)),
                ('desc', models.CharField(verbose_name='商品简介', max_length=130)),
