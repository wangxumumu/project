...
class Books(BaseModel):
	...
	#使用生成器遍历状态的选择(是上线，还是下线)
	status_choices = ((k,v) for k,v in STATUS_CHOICE.items())

	type_id = models.SmallIntegerField(default=PYTHON,choices=books_type_choices,verbose_name='类型id')
	name = models.CharField(max_length=30,verbose_name='商品名称')
	desc = models.CharField(max_length=130,verbose_name='商品简介')
